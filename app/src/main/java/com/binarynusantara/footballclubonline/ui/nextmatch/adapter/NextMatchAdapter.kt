package com.binarynusantara.footballclubonline.ui.nextmatch.adapter
...
class NextMatchAdapter(private val schedule: List<Schedule>) : RecyclerView.Adapter<MainViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        return MainViewHolder(FootballMatchUI().createView(AnkoContext.create(parent.context, parent)))
    }
